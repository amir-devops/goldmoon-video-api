    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {title: 'Motivation Energy', value: 'motivation_energy'},
          {title: 'Fashion House', value: 'fashion_house'},
          {title: 'Summer Breeze', value: 'summer_breeze'},
          {title: 'Tropical Vibes', value: 'tropical_vibes'},
          {title: 'Summer Dance', value: 'summer_dance'},
        ],
        layout: 'radio',
      },
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {title: 'Scale In', value: 'scale_fade'},
          {title: 'Slide + Scale', value: 'slide_scale'},
        ],
        layout: 'dropdown',
      },
    }),
